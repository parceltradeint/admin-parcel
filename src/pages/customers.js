    ...
    <Layout>
      <div>
        ...
        <Modal
          ...
          className={"max-w-5xl"}
        >
          <Modal.Title>{editData ? "Edit Customer" : "Add New Customer"}</Modal.Title>
          <Modal.Content>
            <div>
              <CustomerForm setIsOpen={setIsOpen} data={data} setData={setData} editMode={editData} setEditData={setEditData}/>
            </div>
          </Modal.Content>
        </Modal>
      </div>
