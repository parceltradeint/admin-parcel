              ...
              >
                ...
                {/* {showXButton && (
                  <button
                    type="button"
                    onClick={onClose}
                    className="absolute right-2 top-2 rounded-primary p-1.5 transition-colors duration-150 text-sm text-gray-900 hover:text-gray-700 outline-none focus:outline-none"
                  >
                    &#10005;
                  </button>
                )} */}
